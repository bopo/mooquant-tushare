...
class TestTuShareLiveFeed(TestCase):
    @mock.patch('cn.tushare.barfeed.is_holiday')
    @mock.patch('cn.tushare.barfeed.ts')
    def test__fill_today_bars(self, mock_tushare, mock_is_holiday):
        data_list = [['09:33:45', 9.10, 100, 2000, 0.01],
                     ...
                     ['09:32:59', 9.40, 100, 10, 0.01],
                     ['09:32:45', 9.01, 100, 100, 0.01],
                     ['09:32:13', 9.02, 300, 1000, 0.01],
                     ['09:31:58', 9.03, 300, 2000, 0.01],
                     ['09:31:43', 8.94, 500, 2000, 0.01]
                     ]
        ...
        liveFeed = TuShareLiveFeed(
            ['000581'], 60, dataseries.DEFAULT_MAX_LEN, 0)
        # liveFeed.start()
    ...
    @mock.patch('cn.tushare.barfeed.is_holiday')
    @mock.patch('cn.tushare.barfeed.get_trading_days')
    @mock.patch('cn.tushare.barfeed.ts')
    def test__fill_history_bars(
        ...
        day1_data_list = [['11:00:58', 9.03, 300, 2000, 0.01],
                          ['11:00:43', 8.94, 500, 2000, 0.01]
                          ]
        columns = ['time', 'price', 'volume', 'amount', 'change']
        ...
        day2_data_list = [['10:33:45', 9.10, 100, 2000, 0.01],
                          ['10:33:20', 9.20, 100, 2000, 0.01],
                          ['10:33:00', 9.30, 100, 2000, 0.01]
                          ]
        ...
        liveFeed = TuShareLiveFeed(
            ['000581'], 60, dataseries.DEFAULT_MAX_LEN, 1)
